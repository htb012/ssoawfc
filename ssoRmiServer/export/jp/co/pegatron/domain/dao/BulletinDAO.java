 ...
 * 
 * @see jp.co.pegatron.domain.model.Bulletin
 * @author MyEclipse Persistence Tools
 */

public class BulletinDAO extends BaseHibernateDAO {
	private static final Log log = LogFactory.getLog(BulletinDAO.class);
	// property constants
	public static final String BULLETINTITLE = "bulletintitle";
	public static final String CONTENT = "content";
	public static final String BULLETINTYPE = "bulletintype";
	public static final String BULLETINEXTEND = "bulletinextend";
	...
	public void update(Bulletin transientInstance) {
		log.debug("updating Bulletin instance");
		Session session = getSession();
		Transaction transaction = session.beginTransaction();
		try {
	...
	public Bulletin findById(java.lang.Integer id) {
		...
		Bulletin instance = null;
		Session session = getSession();
		Transaction transaction = session.beginTransaction();
		try {
			instance = (Bulletin) session.get(
					"jp.co.pegatron.domain.model.Bulletin", id);
			transaction.commit();
		} catch (RuntimeException re) {
	...
	public List findByExample(Bulletin instance) {
		...
		try {
			results = session.createCriteria(
					"jp.co.pegatron.domain.model.Bulletin").add(
	...
	public List findByHql(String hql) {
		log.debug("finding Bulletin instance with hql: " + hql);
		List list = null;
		Query query = null;
		Session session = getSession();
		Transaction transaction = session.beginTransaction();
	...
	public List findByBulletintitle(Object bulletintitle) {
		return findByProperty(BULLETINTITLE, bulletintitle);
	}
	...
	public List findByBulletintype(Object bulletintype) {
		return findByProperty(BULLETINTYPE, bulletintype);
	}

	public List findByBulletinextend(Object bulletinextend) {
		return findByProperty(BULLETINEXTEND, bulletinextend);
	}
	...
	public Bulletin merge(Bulletin detachedInstance) {
		...
		Transaction transaction = session.beginTransaction();
		try {
			result = (Bulletin) session.merge(detachedInstance);
			transaction.commit();
